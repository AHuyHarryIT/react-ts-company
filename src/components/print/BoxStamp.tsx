  ...
  return (
    <>
      ...
      <div ref={contentRef} className="print:m-0 print:p-0 print:shadow-none">
        <div className="grid grid-cols-3 grid-rows-2 gap-[20px] not-print:max-w-7xl not-print:grid-cols-1 not-print:border not-print:border-green-400 not-print:p-4 not-print:md:grid-cols-2 not-print:xl:grid-cols-3">
          {product &&
            Array.from({ length: totalBox }, () => product).map(
              (item, index) => (
                <div
                  key={`${index}-${item.code}`}
                ...
                >
                  <table
                    className={`table border border-black ${item.FAVV == 1 ? 'text-[7px]' : 'text-[8px]'}`}
                  >
                    <tbody>
                      <tr>
                      ...
                      <tr>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <p className="text-sx mb-0 font-bold">-</p>
                            <p className="text-sx mb-0 font-bold">
                              {(index + startBox).toString().padStart(3, '0')}
                            </p>
                          </div>
                        </td>
                      </tr>
